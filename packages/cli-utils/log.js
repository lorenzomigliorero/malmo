...
const labels = {
  ...
  'examples.dev': `Launch dev server with watch active using ${chalk.blue('env.development')} configuration`,
  ...
  'options.watch': 'Restart compilation on configuration files changes',
